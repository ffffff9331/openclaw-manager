...
function ModelsTabContent({
  ...
  const modelsPageState = {
    ...
    closeAddModal: modelsState.closeAddModal,
    ...
    addModelProviderMode: modelsState.addModelProviderMode,
    setAddModelProviderMode: modelsState.setAddModelProviderMode,
